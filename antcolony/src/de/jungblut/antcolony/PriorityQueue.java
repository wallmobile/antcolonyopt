...
public class PriorityQueue<T extends Comparable<T>> {
	...
	public PriorityQueue(int maxSize, Class<T> clazz) {
		this(maxSize, true, clazz);
	}

	@SuppressWarnings("unchecked")
	private PriorityQueue(int maxSize, boolean prepopulate, Class<T> clazz2) {
		this.clazz = clazz2;
		size = 0;
		int heapSize;
		if (0 == maxSize)
		...
		heap = (T[]) Array.newInstance(clazz, heapSize); // T is unbounded type,
															// so this
